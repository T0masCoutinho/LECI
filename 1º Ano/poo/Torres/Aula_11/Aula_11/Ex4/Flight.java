...
public class Flight {
    ...
    public Flight(String hour, String flight, String origin, String delay) throws IOException {
        ...
        if (delay.equals(""))
            ...
            this.obs = "Previsto: " + this.getPrediction();
    }
    ...
    public String toString() {
        return String.format("%-7s %-8s %-20s %-21s %-7s %-20s", this.hour, this.flight, this.company, this.origin,
                this.delay, this.obs);
    }

    public int getDelaySeconds() {
        return Integer.parseInt(this.getDelay().substring(0, 2)) * 3600
                + Integer.parseInt(this.getDelay().substring(3, 5)) * 60;
    }
    ...
    private HashMap<String, String> getCompanies() throws IOException {
        ...
        Scanner input = new Scanner(new File("./src/Aula_11/Ex4/companhias.txt"));
        input.nextLine();
