...
SIGNAL ww_dataIn : std_logic_vector(7 DOWNTO 4);
...
SIGNAL \s_count[2]~7_cout\ : std_logic;
SIGNAL \s_count[2]~9_cout\ : std_logic;
SIGNAL \s_count[2]~10_combout\ : std_logic;
SIGNAL \dataIn[6]~input_o\ : std_logic;
SIGNAL \s_count[2]~12_combout\ : std_logic;
SIGNAL \s_count[2]~11\ : std_logic;
SIGNAL \s_count[3]~13_combout\ : std_logic;
...
-- Equation(s):
-- \s_count~2_combout\ = (!\load~input_o\ & (s_count(0) $ (((!\enable~input_o\ & \upDown~input_o\)))))
...
-- Equation(s):
-- \s_count~3_combout\ = (!\s_count~2_combout\ & (!\reset~input_o\ & ((\dataIn[4]~input_o\) # (!\load~input_o\))))
...
-- Equation(s):
-- \s_count~4_combout\ = s_count(1) $ (((s_count(0) & ((!\enable~input_o\) # (!\upDown~input_o\))) # (!s_count(0) & (\upDown~input_o\))))
...
-- Equation(s):
-- \s_count~5_combout\ = (!\reset~input_o\ & ((\load~input_o\ & (\dataIn[5]~input_o\)) # (!\load~input_o\ & ((!\s_count~4_combout\)))))
...
-- Equation(s):
-- \s_count[2]~7_cout\ = CARRY((\Add0~1_combout\ & !\upDown~input_o\))
...
PORT MAP (
	...
	datad => VCC,
	cout => \s_count[2]~7_cout\);

\s_count[2]~9\ : cycloneive_lcell_comb
-- Equation(s):
-- \s_count[2]~9_cout\ = CARRY((\Add0~0_combout\ & (!s_count(1) & !\s_count[2]~7_cout\)) # (!\Add0~0_combout\ & ((!\s_count[2]~7_cout\) # (!s_count(1)))))
...
PORT MAP (
	...
	datab => s_count(1),
	datad => VCC,
	cin => \s_count[2]~7_cout\,
	cout => \s_count[2]~9_cout\);

\s_count[2]~10\ : cycloneive_lcell_comb
-- Equation(s):
-- \s_count[2]~10_combout\ = ((\upDown~input_o\ $ (s_count(2) $ (\s_count[2]~9_cout\)))) # (GND)
-- \s_count[2]~11\ = CARRY((\upDown~input_o\ & (s_count(2) & !\s_count[2]~9_cout\)) # (!\upDown~input_o\ & ((s_count(2)) # (!\s_count[2]~9_cout\))))
...
\s_count[2]~12\ : cycloneive_lcell_comb
-- Equation(s):
-- \s_count[2]~12_combout\ = ((\load~input_o\) # ((\enable~input_o\) # (\reset~input_o\))) # (!\upDown~input_o\)
...
PORT MAP (
	...
	sclr => \reset~input_o\,
	sload => \load~input_o\,
	ena => \s_count[2]~12_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => s_count(2));

\s_count[3]~13\ : cycloneive_lcell_comb
-- Equation(s):
-- \s_count[3]~13_combout\ = \upDown~input_o\ $ (s_count(3) $ (!\s_count[2]~11\))
